...
function renderResult(r){
  ...
  summary.push(`Current DCT estimate: ${fmt(r.sa)} SA combination cows, ${fmt(r.laOrder)} LA combination cows (including clinical/subclinical cases), ${fmt(r.sealantOnly)} teat-sealant-only cows — total ${fmt(r.sealantCows)} cows, requiring ${fmt(r.sealantTubes)} teat-sealant tubes.`);
