...
function buildResult(){
  ...
  return{cows,peak,firstCalvers,recent,sccBuckets,dctCounts,clinical,subclinical,sealantOnly,sa,laBase,laOrder,sealantCows,sealantTubes,saComboTubes,laComboTubes,sealantOnlyTubes,totalTreatmentTubes,pregnant,pregnantSa,pregnantLa,pregnantSealant,emptyHeifers,caseAnalysis,transitionCounts,transitionAvailable,dctRecords,prevProducts,prevCowDct,prevCowSeal,prevComboCurrent,prevSealantOnlyCurrent,prevComboMastitis,prevSealantOnlyMastitis,species,mastaplexGroups,calvingStart,midCalving,coverage,seasonWindow,threshold:ts,laThreshold:la};
}
...
function renderResult(r){
  ...
  summary.push(`Current DCT tube estimate: ${fmt(r.saComboTubes)} SA combination tubes, ${fmt(r.laComboTubes)} LA combination tubes (including clinical/subclinical cases), ${fmt(r.sealantOnlyTubes)} sealant-only tubes; ${fmt(r.totalTreatmentTubes)} tubes total.`);
...
function demoData(){
  ...
  const dct=[{'Cow Number':'101','Treatment Date':new Date(2025,4,20),'Product':'Dryzen'},{'Cow Number':'101','Treatment Date':new Date(2025,4,20),'Product':'Duramast DC 500'},{'Cow Number':'102','Treatment Date':new Date(2025,4,20),'Product':'Dryzen'},{'Cow Number':'102','Treatment Date':new Date(2025,4,20),'Product':'Quadrant DC'},{'Cow Number':'103','Treatment Date':new Date(2025,4,20),'Product':'Dryzen'},{'Cow Number':'107','Treatment Date':new Date(2025,4,20),'Product':'Dryzen'},{'Cow Number':'107','Treatment Date':new Date(2025,4,20),'Product':'Quadrant DC'}];const mp=[{'Cow Number':'103','Species':'Staph. aureus','Quarter':'LF'},{'Cow Number':'107','Species':'Strep. uberis','Quarter':'RR'},{'Cow Number':'111','Species':'CNS','Quarter':'RF'}];
